...
object ValidationUtil {
    ...
    public fun showToast(context: registerFragment, message: String) = Toast.makeText(context, message, Toast.LENGTH_SHORT).show()

    public fun isNullOrEmpty(input: String?): Boolean = input == null || input.isEmpty()

    public fun isValidUsername(
        context: registerFragment,
        username: String?,
    ...
    public fun isValidPassword(context: registerFragment, password: String?): Boolean {
        when {
    ...
    public fun isValidConfirmPassword(context: registerFragment, confirmpassword: String?): Boolean {
        when {
    ...
    public fun ismatchPassword(
        context: registerFragment, password: String?,
